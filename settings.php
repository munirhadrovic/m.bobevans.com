<?php
	$adresa="8111 Smith's Mill Road New Albany,Oh 43054"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=8009392338;// Broj koji se poziva na dugme CALL US
